...
| Создание вспомогательных словарей ([список вводных слов](https://github.com/smekur/Spoken_Corpora_with_Kaldi/blob/master/mistakes_search/dictionaries_txt/parenthesis_rus.txt) и частотных дискурсивных маркеров, список частотных слов с дефисом) | Настя | Done |
