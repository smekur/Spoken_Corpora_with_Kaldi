...
| Объявление функций для для предобработки тестового корпуса | Катя, Настя | Done |
...
| Подбор предобученной векторной модели для минимизации ложно опознанных ошибок (false positives) | Настя | Done |
